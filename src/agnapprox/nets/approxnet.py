...
class ApproxNet(pl.LightningModule):
    ...
    def _train(
        ...
        **kwargs
        ...
        trainer = pl.Trainer(gpus=num_gpus, max_epochs=epochs, **kwargs)
        ...
        with mlflow.start_run(run_name=run_name):
            ...
            # Write layer configuration to temporary JSON file and add as artifact to Mlflow
            if self.mode == "gradient_search":
                ...
                mlflow.log_metric("Energy Reduction", 1 - res["total_saving_factor"])
                mlflow.log_param("lambda", self.lmbd)
    ...
    def train_baseline(self, datamodule: Type[pl.LightningDataModule], **kwargs):
        """
    ...
    def train_quant(self, datamodule: Type[pl.LightningDataModule], **kwargs):
        """
    ...
    def train_gradient(
        ...
        **kwargs
        ...
        self._train(
            datamodule, "Gradient Search", callbacks=verbose_callback, **kwargs
        )
...
class GSVerboseCb(pl.Callback):
    ...
    def on_train_epoch_end(self, _trainer, approxnet):
        ...
        for name, module in approxnet.noisy_modules:
            logger.debug(format_str, name, module.stdev.item())
